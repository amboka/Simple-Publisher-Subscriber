...
static const _TextStamped_type_support_symbol_names_t _TextStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_pkg, msg, TextStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_pkg, msg, TextStamped)),
  }
};
...
{
  return &::custom_msg_pkg::msg::rosidl_typesupport_cpp::TextStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msg_pkg, msg, TextStamped)() {
  return get_message_type_support_handle<custom_msg_pkg::msg::TextStamped>();
}
